...
execute as @p if score @s exp >= @s expneedb if score @s level <= @s ten run scoreboard players operation @s expneed *= @s expconst
execute as @p if score @s exp >= @s expneedb if score @s level > @s ten run scoreboard players operation @s expneed *= @s expconstb
execute as @p if score @s exp >= @s expneedb if score @s level > @s ten run scoreboard players operation @s expneed /= @s expconst
